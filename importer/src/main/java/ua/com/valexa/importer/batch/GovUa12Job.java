...
import ua.com.valexa.common.dto.red.GovUa12Dto;
...
public class GovUa12Job {
    ...
    @Autowired
    private ItemReader<GovUa12Dto> govua12reader;

    @Autowired
    private ItemProcessor<GovUa12Dto, GovUa12> govua12processor;

    @Autowired
    private JdbcBatchItemWriter<GovUa12> govua12writer;
...
//                System.out.println("afterWrite // handledRowsCount: " + handledRowsCount + "  duplicateRowsCount: " + duplicateRowsCount + " errorsCount:" + errorsCount);
            ...
            @Override
            public void beforeWrite(Chunk<? extends GovUa12> items) {
            ...
            @Override
            public void onWriteError(Exception exception, Chunk<? extends GovUa12> items) {
